...
// ShariNormalDay is adapter following method that proposed by Mohamed Nabeel
// Tarabishy, Ph.D.
//
// He proposes that a normal day is defined as day when the fasting period is between
// 10h17m and 17h36m. If the day is "abnormal" then the fasting times is calculated
// using the schedule for area with 45 degrees latitude.
//
...
//
// Do note in this method there will be sudden changes in the length of the day of
// fasting. To avoid this issue, the author has given suggestion to just use the
// schedule from 45° on permanent basis. So, following that suggestion, you might be
// better using other adapter like `NearestLatitude` or `NearestLatitudeAsIs`.
//
